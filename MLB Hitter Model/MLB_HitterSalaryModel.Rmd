---
title: "DSFP: MLB Hitter Salary Prediction Model"
author: "Ethan Shear & Team 40"
date: "October 2022"
...
# read in train data
baseball <- read.csv("MLBMOD_train.csv")
  ...
  # read in test data
deployment <- read.csv("MLBMOD_test.csv")
...
# write.csv(finTrain, file = "MLBMOD_train.csv")
```
...
# write.csv(deployDF, file = "MLBMOD_test.csv")
```
